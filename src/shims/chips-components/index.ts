/**
 * Vue shim layer for @chips/components
 * @module shims/chips-components
 * @description 提供与 React 组件库同名的 Vue 组件，使用原生 HTML 元素实现。
 *
 * Chips-ComponentLibrary 是纯 React 库，无法在 Vue 应用中直接使用。
 * 此 shim 层导出同名 Vue 组件，保持相同的 CSS class 命名以兼容主题系统。
 */
