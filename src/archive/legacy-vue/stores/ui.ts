...
export const useUIStore = defineStore('ui', {
  ...
  actions: {
     ...
     */
    fitToViewport(): void {
      const visibleWindows = this.windowList.filter((window) => window.state !== 'minimized');
      ...
      this.canvas.panX = viewportWidth / 2 - centerX * zoom;
      this.canvas.panY = viewportHeight / 2 - centerY * zoom;
    },
